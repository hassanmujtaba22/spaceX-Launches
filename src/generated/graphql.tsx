...
export type LaunchesInfoQuery = (
  ...
  & { launch?: Maybe<(
    { __typename?: 'Launch' }
    & Pick<Launch, 'flight_number' | 'mission_name' | 'launch_year' | 'launch_success' | 'launch_date_local' | 'ships' | 'details'>
    & { rocket?: Maybe<(
      { __typename?: 'LaunchRocket' }
      ...
      { __typename?: 'LaunchLinks' }
      & Pick<LaunchLinks, 'video_link' | 'flickr_images' | 'article_link'>
    )> }
  )> }
);

export type LaucnhesQueryVariables = Exact<{ [key: string]: never; }>;


export type LaucnhesQuery = (
  { __typename?: 'Query' }
  & { launches?: Maybe<Array<Maybe<(
    { __typename?: 'Launch' }
    & Pick<Launch, 'flight_number' | 'mission_name' | 'launch_year' | 'launch_success' | 'launch_date_local'>
  )>>> }
);
...
export const LaucnhesDocument = gql`
    query Laucnhes {
  launches {
    flight_number
    mission_name
...
/**
 * __useLaucnhesQuery__
 *
 * To run a query within a React component, call `useLaucnhesQuery` and pass it any options that fit your needs.
 * When your component renders, `useLaucnhesQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useLaucnhesQuery({
 *   variables: {
 *   },
 * });
 */
export function useLaucnhesQuery(baseOptions?: Apollo.QueryHookOptions<LaucnhesQuery, LaucnhesQueryVariables>) {
        return Apollo.useQuery<LaucnhesQuery, LaucnhesQueryVariables>(LaucnhesDocument, baseOptions);
      }
export function useLaucnhesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<LaucnhesQuery, LaucnhesQueryVariables>) {
          return Apollo.useLazyQuery<LaucnhesQuery, LaucnhesQueryVariables>(LaucnhesDocument, baseOptions);
        }
export type LaucnhesQueryHookResult = ReturnType<typeof useLaucnhesQuery>;
export type LaucnhesLazyQueryHookResult = ReturnType<typeof useLaucnhesLazyQuery>;
export type LaucnhesQueryResult = Apollo.QueryResult<LaucnhesQuery, LaucnhesQueryVariables>;